...
public class LVQ extends Rede{
	...
	int numero_de_instancias = 4;		// vetores_de_entrada[i]
	int dimensao = 2;					// da entrada
	...
	public LVQ(int numero_neuronios_classe, int numero_de_classes, double taxa_de_aprendizado, double[] classes){	
	...
	void set_problema (Matrix entrada, Matrix saida_desejada){
		...
		this.numero_de_instancias = 4/*entrada.getRowDimension()*/;
		this.dimensao = 2/*entrada.getColumnDimension()*/;
	...
	void imprime_atributos(){
		System.out.println("Numero de classes: " + numero_de_classes);
		System.out.println("Numero de instancias: " + numero_de_instancias);
		System.out.println("Dimensao: " + dimensao);
		System.out.println("Numero de neuronios por classes: " + numero_neuronios_saida);
		System.out.println("Taxa de aprendizado: " + taxa_de_aprendizado);
	}
